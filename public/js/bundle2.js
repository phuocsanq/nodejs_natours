...
},{}],"openstreetmap.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locationsData) {
  ...
  locationsData.forEach(function (location) {
    ...
    var name = locationsData.length === 1 ? address : "Day ".concat(day, ": ").concat(address);
    var marker = L.marker([latitude, longitude]).addTo(map);
    marker.bindTooltip(name).openTooltip();
  });

  // view all location
  var group = new L.featureGroup(locationsData.map(function (location) {
    return L.marker([location.coordinates[1], location.coordinates[0]]);
  }));
...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector('.my-alert');
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"my-alert my-alert--".concat(type, "\">").concat(msg, "</div>");
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password, redirectUrl) {
    var res;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Lỗi! Vui lòng thử lại.');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Đăng ký tài khoản thành công!');
            window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"requestResetEmail.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.requestResetEmail = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var requestResetEmail = exports.requestResetEmail = /*#__PURE__*/function () {
  ...
  return function requestResetEmail(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"payOS.js":[function(require,module,exports) {
"use strict";
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, quantity) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/bookings/create-payment-link/".concat(tourId, "/").concat(quantity)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Going checkout!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"searchTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getSearchTourForm = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var getSearchTourForm = exports.getSearchTourForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(searchParams) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          (0, _alerts.showAlert)('notification', 'Vui lòng chọn điểm đi!');
          return _context.abrupt("return", 0);
        case 4:
          window.location.href = "/search-tour?".concat(searchParams.toString());
          _context.next = 10;
          break;
        case 7:
          _context.prev = 7;
  ...
  return function getSearchTourForm(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.updateUserPassword = exports.updateUserInfor = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var updateUserInfor = exports.updateUserInfor = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId, name, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Cập nhật thông tin người dùng thành công!');
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i c\u1EADp nh\u1EADt th\xF4ng tin ng\u01B0\u1EDDi d\xF9ng: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function updateUserInfor(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
var updateUserPassword = exports.updateUserPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId, password, passwordConfirm, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "/api/v1/users/".concat(userId, "/updateUserPassword"),
            data: {
              password: password,
              passwordConfirm: passwordConfirm
            }
        ...
        case 4:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Cập nhật mật khẩu người dùng thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 8:
          _context2.prev = 8;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i c\u1EADp nh\u1EADt m\u1EADt kh\u1EA9u ng\u01B0\u1EDDi d\xF9ng: ".concat(_context2.t0.response.data.message));
        case 11:
        case "end":
          return _context2.stop();
      }
  ...
  return function updateUserPassword(_x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref2.apply(this, arguments);
  };
}();
...
var createUser = exports.createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, role, password, passwordConfirm, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Thêm người dùng thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i th\xEAm ng\u01B0\u1EDDi d\xF9ng: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function createUser(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteUser = exports.deleteUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Xoá người dùng thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i xo\xE1 ng\u01B0\u1EDDi d\xF9ng: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteBooking.js":[function(require,module,exports) {
"use strict";
...
var deleteBooking = exports.deleteBooking = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Xoá booking thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i xo\xE1 booking: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function deleteBooking(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var createTour = exports.createTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(formData, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Thêm tour thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i th\xEAm tour: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"saveTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.saveTour = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var saveTour = exports.saveTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, formData, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Cập nhật tour thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i c\u1EADp nh\u1EADt tour: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function saveTour(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteTour = exports.deleteTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Xoá tour thành công!');
            $.get(window.location.href, {
              page: page + 1,
              rowsPerPage: rowsPerPage,
              search: searchQuery
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "L\u1ED7i xo\xE1 tour: ".concat(_context.t0.response.data.message));
        case 10:
        case "end":
          return _context.stop();
      }
  ...
  return function deleteTour(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateGuide.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateGuidePassword = exports.updateGuideInfor = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var updateGuideInfor = exports.updateGuideInfor = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId, name, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
  ...
  return function updateGuideInfor(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
var updateGuidePassword = exports.updateGuidePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId, password, passwordConfirm, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
  ...
  return function updateGuidePassword(_x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createGuide.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createGuide = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var createGuide = exports.createGuide = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, role, password, passwordConfirm, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
  ...
  return function createGuide(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteGuide.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteGuide = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var deleteGuide = exports.deleteGuide = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId, page, rowsPerPage, searchQuery) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
  ...
  return function deleteGuide(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var _requestResetEmail = require("./requestResetEmail");
var _resetPassword = require("./resetPassword");
var _payOS = require("./payOS");
var _searchTour = require("./searchTour");
...
var _saveTour = require("./saveTour");
var _deleteTour = require("./deleteTour");
var _updateGuide = require("./updateGuide");
var _createGuide = require("./createGuide");
var _deleteGuide = require("./deleteGuide");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
...
var requestResetEmailForm = document.querySelector('.form--request-reset-email');
var resetPasswordForm = document.querySelector('.form--reset-password');
var bookBtn = document.getElementById('book-tour');
var bookingInforForm = document.querySelector('.booking-infor-form');
var searchTourBtn = document.getElementById('searchTourBtn');
var btnChangUserInfor = document.getElementById('changUserInfor');
var btnChangUserPass = document.getElementById('changUserPass');
var btnAddUser = document.getElementById('btnAddUser');
var btnDeleteUser = document.getElementById('deleteUser');
var btnChangGuideInfor = document.getElementById('changGuideInfor');
var btnChangGuidePass = document.getElementById('changGuidePass');
var btnAddGuide = document.getElementById('btnAddGuide');
var btnDeleteGuide = document.getElementById('deleteGuide');
var btnDeleteTour = document.getElementById('deleteTour');
var btnDeleteBooking = document.getElementById('deleteBooking');
var addTourForm = document.querySelector('.form--add-tour');

// DELEGATION
if (mapBox) {
  var locationsData = JSON.parse(mapBox.getAttribute('data-locations'));
  (0, _openstreetmap.displayMap)(locationsData);
}
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  var redirectUrl = params.get('redirect') ? decodeURIComponent(params.get('redirect')) : '/';
  (0, _login.login)(email, password, redirectUrl);
...
if (requestResetEmailForm) requestResetEmailForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return (0, _requestResetEmail.requestResetEmail)(email);
        case 5:
          if (!_context2.sent) {
            _context2.next = 9;
            break;
          }
          document.querySelector('.lable-request-email').textContent = "Ki\u1EC3m tra email \u0111\u1EC3 \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u. \n      Ch\xFAng t\xF4i \u0111\xE3 g\u1EEDi m\u1ED9t email ch\u1EE9a li\xEAn k\u1EBFt \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u \u0111\u1EBFn \u0111\u1ECBa ch\u1EC9 email \u0111\u01B0\u1EE3c \u0111\u0103ng k\xFD. \n      Vui l\xF2ng truy c\u1EADp h\u1ED9p th\u01B0 \u0111\u1EBFn c\u1EE7a t\xE0i kho\u1EA3n email v\xE0 nh\u1EA5p v\xE0o li\xEAn k\u1EBFt \u0111\u1EC3 ho\xE0n t\u1EA5t qu\xE1 tr\xECnh \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u \uD83D\uDD14\uD83D\uDCE9";
...
if (resetPasswordForm) resetPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
    var password, passwordConfirm, url, path, resetToken;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          e.preventDefault();
          ...
          path = url.pathname;
          resetToken = path.substring(path.lastIndexOf('/') + 1);
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var quantity = myInput.getAttribute("value");
  (0, _payOS.bookTour)(tourId, quantity);
...
if (searchTourBtn) {
  searchTourBtn.addEventListener('click', function () {
    var type = document.getElementById('domesticBtn').classList.contains('active') ? 'domestic' : 'international';
    ...
    (0, _searchTour.getSearchTourForm)(searchParams);
  });
}
/////

if (btnChangUserInfor) btnChangUserInfor.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
  var form, exampleModal, userId, updatedName, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        form = btnChangUserInfor.closest('form');
        if (form.checkValidity()) {
          exampleModal = document.getElementById('exampleModalChangeUserInfor');
          userId = exampleModal.querySelector('.modal-body input#staticId').value;
          updatedName = exampleModal.querySelector('.modal-body input#staticName').value; // const updatedRole = exampleModal.querySelector('.modal-body select#staticRole').value;
          //- console.log(userId, updatedName, updatedRole)
          searchQuery = $('#searchUser').val();
          page = $('.page-link').data('page');
          rowsPerPage = $('.rowsPerPage').val();
          (0, _updateUser.updateUserInfor)(userId, updatedName, page, rowsPerPage, searchQuery);
...
if (btnChangUserPass) btnChangUserPass.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
  var form, exampleModal, userId, password, passwordConfirm, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee5$(_context5) {
    while (1) switch (_context5.prev = _context5.next) {
      case 0:
        form = btnChangUserPass.closest('form');
        if (form.checkValidity()) {
          exampleModal = document.getElementById('exampleModalChangeUserInfor');
          userId = exampleModal.querySelector('.modal-body input#staticId').value;
          password = exampleModal.querySelector('.modal-body input#staticPassword').value;
          passwordConfirm = exampleModal.querySelector('.modal-body input#staticPasswordConfirm').value; // - console.log(userId, password, passwordConfirm)
          searchQuery = $('#searchUser').val();
          page = $('.page-link').data('page');
          rowsPerPage = $('.rowsPerPage').val();
          (0, _updateUser.updateUserPassword)(userId, password, passwordConfirm, page, rowsPerPage, searchQuery);
        }
      case 2:
      case "end":
...
if (btnAddUser) btnAddUser.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
  var form, exampleModal, name, email, role, password, passwordConfirm, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee6$(_context6) {
    while (1) switch (_context6.prev = _context6.next) {
      case 0:
        form = btnAddUser.closest('form');
        if (form.checkValidity()) {
          exampleModal = document.getElementById('exampleModalAddUser');
          name = exampleModal.querySelector('.modal-body input#staticAddName').value;
          email = exampleModal.querySelector('.modal-body input#staticAddEmail').value; // const role = exampleModal.querySelector('.modal-body select#staticAddRole').value;
          role = 'user';
          password = exampleModal.querySelector('.modal-body input#staticAddPassword').value;
          passwordConfirm = exampleModal.querySelector('.modal-body input#staticAddPasswordConfirm').value;
          searchQuery = $('#searchUser').val();
          page = $('.page-link').data('page');
          rowsPerPage = $('.rowsPerPage').val();
          (0, _createUser.createUser)(name, email, role, password, passwordConfirm, page, rowsPerPage, searchQuery);
        }
      case 2:
      case "end":
...
if (btnDeleteUser) btnDeleteUser.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
  var exampleModal, id, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee7$(_context7) {
    while (1) switch (_context7.prev = _context7.next) {
      case 0:
        exampleModal = document.getElementById('exampleModalDeleteUser');
        id = exampleModal.querySelector('.modal-body input#staticDeleteId').value;
        searchQuery = $('#searchUser').val();
        page = $('.page-link').data('page');
        rowsPerPage = $('.rowsPerPage').val();
        (0, _deleteUser.deleteUser)(id, page, rowsPerPage, searchQuery);
      case 6:
      case "end":
...
////
if (btnChangGuideInfor) btnChangGuideInfor.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
  var form, exampleModal, userId, updatedName, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee8$(_context8) {
    while (1) switch (_context8.prev = _context8.next) {
      case 0:
        form = btnChangGuideInfor.closest('form');
        if (form.checkValidity()) {
          exampleModal = document.getElementById('exampleModalChangeGuideInfor');
          userId = exampleModal.querySelector('.modal-body input#staticId').value;
          updatedName = exampleModal.querySelector('.modal-body input#staticName').value;
          searchQuery = $('#searchGuide').val();
          page = $('.page-link').data('page');
          rowsPerPage = $('.rowsPerGuidePage').val();
          (0, _updateGuide.updateGuideInfor)(userId, updatedName, page, rowsPerPage, searchQuery);
        }
      case 2:
      case "end":
...
if (btnChangGuidePass) btnChangGuidePass.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
  var form, exampleModal, userId, password, passwordConfirm, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee9$(_context9) {
    while (1) switch (_context9.prev = _context9.next) {
      case 0:
        form = btnChangGuidePass.closest('form');
        if (form.checkValidity()) {
          exampleModal = document.getElementById('exampleModalChangeGuideInfor');
          userId = exampleModal.querySelector('.modal-body input#staticId').value;
          password = exampleModal.querySelector('.modal-body input#staticPassword').value;
          ...
          page = $('.page-link').data('page');
          rowsPerPage = $('.rowsPerGuidePage').val();
          (0, _updateGuide.updateGuidePassword)(userId, password, passwordConfirm, page, rowsPerPage, searchQuery);
        }
      case 2:
      case "end":
...
if (btnAddGuide) btnAddGuide.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
  var form, exampleModal, name, email, role, password, passwordConfirm, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee10$(_context10) {
    while (1) switch (_context10.prev = _context10.next) {
      case 0:
        form = btnAddGuide.closest('form');
        if (form.checkValidity()) {
          exampleModal = document.getElementById('exampleModalAddGuide');
          name = exampleModal.querySelector('.modal-body input#staticAddName').value;
          email = exampleModal.querySelector('.modal-body input#staticAddEmail').value; // const role = exampleModal.querySelector('.modal-body select#staticAddRole').value;
          role = 'guide';
          password = exampleModal.querySelector('.modal-body input#staticAddPassword').value;
          ...
          page = $('.page-link').data('page');
          rowsPerPage = $('.rowsPerGuidePage').val();
          (0, _createGuide.createGuide)(name, email, role, password, passwordConfirm, page, rowsPerPage, searchQuery);
        }
      case 2:
      case "end":
...
if (btnDeleteGuide) btnDeleteGuide.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
  var exampleModal, id, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee11$(_context11) {
    while (1) switch (_context11.prev = _context11.next) {
      case 0:
        exampleModal = document.getElementById('exampleModalDeleteGuide');
        id = exampleModal.querySelector('.modal-body input#staticDeleteId').value;
        searchQuery = $('#searchGuide').val();
        page = $('.page-link').data('page');
        rowsPerPage = $('.rowsPerGuidePage').val();
        (0, _deleteGuide.deleteGuide)(id, page, rowsPerPage, searchQuery);
      case 6:
      case "end":
...
if (addTourForm) {
  ...
  $('#btnAddTour').on('click', function () {
    ...
    // Append files
    var imageCover = document.getElementById('tourCoverImg').files[0];
    if (imageCover) {
      formData.append('imageCover', imageCover);
    }
    var images = document.getElementById('tourImg').files;
    ...
    var searchQuery = $('#searchTour').val();
    var page = $('.page-link').data('page');
    var rowsPerTourPage = $('.rowsPerTourPage').val();
    (0, _createTour.createTour)(formData, page, rowsPerTourPage, searchQuery);
  ...
  $('#btnSaveTour').on('click', function () {
    ...
    var page = $('.page-link').data('page');
    var rowsPerTourPage = $('.rowsPerTourPage').val();
    (0, _saveTour.saveTour)(tourId, formData, page, rowsPerTourPage, searchQuery);
  });
}
if (btnDeleteTour) btnDeleteTour.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
  var exampleModal, id, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee12$(_context12) {
    while (1) switch (_context12.prev = _context12.next) {
      case 0:
        console.log('delete tour clicked');
        exampleModal = document.getElementById('exampleModalDeleteTour');
        id = exampleModal.querySelector('.modal-body input#deleteTourId').value;
        searchQuery = $('#searchGuide').val();
        page = $('.page-link').data('page');
        rowsPerPage = $('.rowsPerTourPage').val();
        (0, _deleteTour.deleteTour)(id, page, rowsPerPage, searchQuery);
      case 7:
      case "end":
...
if (btnDeleteBooking) btnDeleteBooking.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
  var exampleModal, id, searchQuery, page, rowsPerPage;
  return _regeneratorRuntime().wrap(function _callee13$(_context13) {
    while (1) switch (_context13.prev = _context13.next) {
      case 0:
        exampleModal = document.getElementById('exampleModalDeleteBooking');
        id = exampleModal.querySelector('.modal-body label#deleteBookingId').textContent;
        searchQuery = $('#searchBooking').val();
        page = $('.page-link').data('page');
        rowsPerPage = $('.rowsPerBookingPage').val();
        (0, _deleteBooking.deleteBooking)(id, page, rowsPerPage, searchQuery);
      case 6:
      case "end":
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var port = location.protocol === 'https:' ? location.port: 25596; 
