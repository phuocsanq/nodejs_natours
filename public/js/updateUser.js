...
export const updateUserInfor = async (userId, name, page, rowsPerPage, searchQuery) => {
  try {
...
export const updateUserPassword = async (userId, password, passwordConfirm, page, rowsPerPage, searchQuery) => {
  try {
